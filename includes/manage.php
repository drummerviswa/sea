...
class Manage
{
    ...
    public function manageRecordWithPagination($table, $pno)
    {
        ...
        if ($table == "categories") {
            ...
            $sql = "SELECT p.pid,p.product_name,c.category_name,b.brand_name,p.product_price,p.product_stock,p.add_date,p.p_status FROM products p,brands b,categories c WHERE p.bid = b.bid AND p.cid = c.cid ";
        } else {
